...
public abstract class AbstractTrizonCard<T> extends CustomCard implements CustomSavable<T> {
    ...
    public AbstractTrizonCard(String id, String name, String img, int cost, String rawDescription,
    ...
    public AbstractCard makeStatEquivalentCopy() {
        AbstractTrizonCard<?> copy = (AbstractTrizonCard<?>) super.makeStatEquivalentCopy();
